                        ...
                        foreach (string spss_v in spss_variable_name)
                        {
                            if (variable.Name.Equals(spss_v))
                            {
                                ...
                                switch (variable_name)
                                {
                                    ...
                                    case "GEN": { AgeGroup = Convert.ToString(record.GetValue(variable)); break; }
                                    case "S2a": { Gender = Convert.ToString(record.GetValue(variable)); break; }
                                    ...
                                    case "B4_1": { BrAided_Absolute_Distilled_W = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B4_11": { BrAided_Nature_Spring_Alkaline_DW = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B4_12": { BrAided_Nature_Spring_Distilled_DW = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B4_13": { BrAided_Nature_Spring_Purified_DW = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B4_25": { BrAided_Refresh_Mineral_W = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B4_26": { BrAided_Refresh_Purified_W = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B4_29": { BrAided_Summit_Spring_W = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B4_45": { BrAided_Wet_Water_Mineral_W = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B4_47": { BrAided_Wilkins_Distilled_W = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B4_51": { BrAided_Wilkins_Pure_Water_Purified_W = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B4_54": { BrAided_LE_MINERALE = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B4_80": { BrAided_Sip_Purified_W = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B4_81": { BrAided_Aquafina_Purified_W = Convert.ToString(record.GetValue(variable)); break; }
                                    ...
                                    case "B5_1": { AdAided_Absolute_Distilled_W = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B5_11": { AdAided_Nature_Spring_Alkaline_DW = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B5_12": { AdAided_Nature_Spring_Distilled_DW = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B5_13": { AdAided_Nature_Spring_Purified_DW = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B5_25": { AdAided_Refresh_Mineral_W = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B5_26": { AdAided_Refresh_Purified_W = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B5_29": { AdAided_Summit_Spring_W = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B5_45": { AdAided_Wet_Water_Mineral_W = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B5_47": { AdAided_Wilkins_Distilled_W = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B5_51": { AdAided_Wilkins_Pure_Water_Purified_W = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B5_54": { AdAided_LE_MINERALE = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B5_80": { AdAided_Sip_Purified_W = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B5_81": { AdAided_Aquafina_Purified_W = Convert.ToString(record.GetValue(variable)); break; }
                                    ...
                                    case "B3_TOM_NET": { AdTom = Convert.ToString(record.GetValue(variable)); break; }
